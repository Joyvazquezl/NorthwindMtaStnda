		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products_MTA_Stnda",
									"targetURL": "#nsproductsmtastnda-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsproductsmtastnda-display": {
								"semanticObject": "nsproductsmtastnda",
								"action": "display",
								"description": "Products MTA Standalone",
								"title": "Products_MTA_Stnda",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.productsmtastnda",
									"url": sap.ui.require.toUrl("ns/productsmtastnda")
								}
							}
						}
					}
